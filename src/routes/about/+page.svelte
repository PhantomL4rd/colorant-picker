...
<svelte:head>
  <title>{$t('common.nav.about')} | {$t('common.app.name')}</title>
  <meta name="description" content={$t('page.home.about.p1')} />
  <link rel="canonical" href="https://colorant-picker.pl4rd.com/about" />
